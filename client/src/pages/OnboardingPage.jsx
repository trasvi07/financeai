    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="mb-8">
            ...
            {STEPS.map((s, i) => (
              <div key={s} className="flex items-center gap-2">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium transition-all
                  ${i < step ? 'bg-indigo-600 text-white' : i === step ? 'bg-indigo-600/20 border-2 border-indigo-500 text-indigo-400' : 'bg-gray-800 text-gray-500'}`}>
          ...
          <p className="text-center text-sm text-gray-400 mt-3">Step {step + 1} of {STEPS.length}: {STEPS[step]}</p>
        </div>
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {CATEGORIES.map(cat => (
                  <button key={cat}
                    onClick={() => toggleItem('topCategories', cat)}
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => setStep(2)} className="btn-primary flex-1 flex items-center justify-center gap-2 py-3"
